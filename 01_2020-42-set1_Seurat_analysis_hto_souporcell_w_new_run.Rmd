---
title: "2020-42-set1_hto_souporcell"
author: "Timothée B"
date: "22/02/2022"
output:
  html_document:
...
knitr::opts_knit$set(root.dir = "/home/bigott/workspace2/01_tim/01_these/01_etv6/07_Rapport/01_2020-42-set1/")
```
...
OUTPUT_PATH <- "/home/bigott/workspace2/01_tim/01_these/01_etv6/05_Outputs/06_Février_2022/01_2020-42-set1/"
...
# Load path for files
PATH_HUMAN_DATA1 <- "/home/bigott/workspace2/01_tim/01_these/01_etv6/04_data/01_2020-42-set1/01_cellranger_run2020-42-set1_GRCh382020A_CR5/outs/filtered_feature_bc_matrix/"
SAMPLE1 <- "ETV6_D6"
PATH_HTO_DATA1 <- "/home/bigott/workspace2/01_tim/01_these/01_etv6/04_data/01_2020-42-set1/02_run_24_02_22/umi_count/"
PATH_SOUPORCELL_DATA1 <- "/home/bigott/workspace2/01_tim/01_these/02_Souporcell/01_2020-42-set1/02_run_24_02_22/"
```
...
# 		paste("cluster", i,"markers_2020-42-set1.txt", sep = "_"),
...
```{r echo=FALSE}
gene_list <- c("TF","PROCR","CD31","PCAM1","CD34","THBD","ICAM1","MCAM","VCAM1","SELE","CD146","ENG","CDH5","KDR")
...
# 	    "log_norm_filtered_2020-42-set1_patients.txt",
# 	    sep="\t", quote=F, col.names=NA)
```
...
# write.table(pca_coordinates,
# 	   "PCA_coordinates_2020-42-set1_patients.txt",
# 	    sep="\t", quote=F, col.names=NA
# )
```
...
# write.table(clusters_res,
# 	    "clusters_res_0.8_2020-42-set1_patients.txt",
# 	    sep="\t", quote=F, col.names=NA)
```
...
# write.table(UMAP_coord,
# 	    "UMAP_coordinates_2020-42-set1_patients.txt",
# 	    sep="\t", quote=F, col.names=NA
# )
```
...
#     print(head(get(paste("cluster", i,".markers", sep = "")),n=50))
#     write.table(get(paste("cluster", i,".markers", sep = "")),
# 		paste("cluster", i,"markers_2020-42-set1_patients", sep = "_"),
# 		quote=FALSE,row.names = TRUE)
# }
```
...
# write.table(metadata,
# 	    "metadata_2020-42-set1_patients.txt",
# 	    sep='\t', quote=F, col.names=NA)
```
...
# 	    paste("log_norm_filtered_2020-42-set1_ctrl.txt",sep=""),
# 	    sep="\t", quote=F, col.names=NA)
```
...
# write.table(pca_coordinates,
# 	    "PCA_coordinates_2020-42-set1_ctrl.txt",
# 	    sep="\t", quote=F, col.names=NA
# )
```
...
# write.table(UMAP_coord,
# 	    "UMAP_coordinates_2020-42-set1_ctrl.txt",
# 	    sep="\t", quote=F, col.names=NA
# )
```
...
#     print(head(get(paste("cluster", i,".markers", sep = "")),n=50))
#     write.table(get(paste("cluster", i,".markers", sep = "")),
# 		paste("cluster", i,"markers_2020-42-set1_ctrl.txt", sep = "_"),
# 		quote=FALSE,row.names = TRUE)
# }
```
...
# 
# write.table(metadata,
# 	    "metadata_2020-42-set1_ctrl.txt",
# 	    sep='\t', quote=F, col.names=NA)
