...
```{r}
INPUT_PATH <- "/home/hannouchel/workspace//ETV6/04_data/2020-42-set1-set2-Figure-Tim/ETV6_radarplot_fig/2e_essai_after_souporcell_processing/input"
OUTPUT_PATH <- "/home/hannouchel/workspace/ETV6/04_data/2020-42-set1-set2-Figure-Tim/Trajectoires"
```
...
## We can also plot gene of interest accross lineages
```{r}
setwd(OUTPUT_PATH)

curvesCols <- c("#440154FF", "red", "transparent", "transparent", "transparent", "transparent")

curvesCols2 <- c("#CD9600","#7CAE00","#04BF68","#F26D6D","#05AFF2","#CC88FF","pink")

svg("RUNX1.svg", width = 7, height = 7)
plotSmoothers(sce_fitGAM, counts_matrix,  rownames(counts_matrix)[which(rownames(counts_matrix) == "RUNX1")],pointCol = ETV6_2020@meta.data$celltypes, curvesCols = curvesCols, lwd = 1.2, size = 0.3,
  border = FALSE)  + 
  ggplot2::scale_color_manual(values = curvesCols2) + 
  ggtitle("RUNX1",) +
  theme(plot.title = element_text(hjust = 0.5))
dev.off()

svg("GATA1.svg", width = 7, height = 7)
plotSmoothers(sce_fitGAM, counts_matrix,  rownames(counts_matrix)[which(rownames(counts_matrix) == "GATA1")],pointCol = ETV6_2020@meta.data$celltypes, curvesCols = curvesCols,
  border = FALSE)  + 
  ggplot2::scale_color_manual(values = curvesCols2) + 
  ggtitle("GATA1",) +
  theme(plot.title = element_text(hjust = 0.5))
...
svg("GATA2.svg", width = 7, height = 7)
plotSmoothers(sce_fitGAM, counts_matrix,  rownames(counts_matrix)[which(rownames(counts_matrix) == "GATA2")],pointCol = ETV6_2020@meta.data$celltypes, curvesCols = curvesCols,
  border = FALSE)  + 
  ggplot2::scale_color_manual(values = curvesCols2)  + 
  ggtitle("GATA2",) +
  theme(plot.title = element_text(hjust = 0.5))
...
svg("FLI1.svg", width = 7, height = 7)
plotSmoothers(sce_fitGAM, counts_matrix,  rownames(counts_matrix)[which(rownames(counts_matrix) == "FLI1")],pointCol = ETV6_2020@meta.data$celltypes, curvesCols = curvesCols,
  border = FALSE)  + 
  ggplot2::scale_color_manual(values = curvesCols2)  + 
  ggtitle("FLI1",) +
  theme(plot.title = element_text(hjust = 0.5))
...
svg("CEBPA.svg", width = 7, height = 7)
plotSmoothers(sce_fitGAM, counts_matrix,  rownames(counts_matrix)[which(rownames(counts_matrix) == "CEBPA")],pointCol = ETV6_2020@meta.data$celltypes, curvesCols = curvesCols,
  border = FALSE)  + 
...
svg("TAL1.svg", width = 7, height = 7)
plotSmoothers(sce_fitGAM, counts_matrix,  rownames(counts_matrix)[which(rownames(counts_matrix) == "TAL1")],pointCol = ETV6_2020@meta.data$celltypes, curvesCols = curvesCols,
  border = FALSE)  + 
  ggplot2::scale_color_manual(values = curvesCols2)  + 
  ggtitle("TAL1",) +
  theme(plot.title = element_text(hjust = 0.5))
...
svg("NFE2.svg", width = 7, height = 7)
plotSmoothers(sce_fitGAM, counts_matrix,  rownames(counts_matrix)[which(rownames(counts_matrix) == "NFE2")],pointCol = ETV6_2020@meta.data$celltypes, curvesCols = curvesCols,
  border = FALSE)  + 
  ggplot2::scale_color_manual(values = curvesCols2)  + 
  ggtitle("NFE2",) +
  theme(plot.title = element_text(hjust = 0.5))
...
svg("CD34.svg", width = 7, height = 7)
plotSmoothers(sce_fitGAM, counts_matrix,  rownames(counts_matrix)[which(rownames(counts_matrix) == "CD34")],pointCol = ETV6_2020@meta.data$celltypes, curvesCols = curvesCols,
  border = FALSE)  + 
  ggplot2::scale_color_manual(values = curvesCols2)  + 
  ggtitle("CD34",) +
  theme(plot.title = element_text(hjust = 0.5))
...
svg("CD38.svg", width = 7, height = 7)
plotSmoothers(sce_fitGAM, counts_matrix,  rownames(counts_matrix)[which(rownames(counts_matrix) == "CD38")],pointCol = ETV6_2020@meta.data$celltypes, curvesCols = curvesCols,
  border = FALSE)  + 
  ggplot2::scale_color_manual(values = curvesCols2)  + 
  ggtitle("CD38",) +
  theme(plot.title = element_text(hjust = 0.5))
...
svg("HLA-DRA.svg", width = 7, height = 7)
plotSmoothers(sce_fitGAM, counts_matrix,  rownames(counts_matrix)[which(rownames(counts_matrix) == "HLA-DRA")],pointCol = ETV6_2020@meta.data$celltypes, curvesCols = curvesCols,
  border = FALSE)  + 
  ggplot2::scale_color_manual(values = curvesCols2)  + 
  ggtitle("HLA-DRA",) +
  theme(plot.title = element_text(hjust = 0.5))
...
svg("GP9.svg", width = 7, height = 7)
plotSmoothers(sce_fitGAM, counts_matrix,  rownames(counts_matrix)[which(rownames(counts_matrix) == "GP9")],pointCol = ETV6_2020@meta.data$celltypes, curvesCols = curvesCols,
  border = FALSE)  + 
  ggplot2::scale_color_manual(values = curvesCols2)  + 
  ggtitle("GP9",) +
  theme(plot.title = element_text(hjust = 0.5))
...
svg("PF4.svg", width = 7, height = 7)
plotSmoothers(sce_fitGAM, counts_matrix,  rownames(counts_matrix)[which(rownames(counts_matrix) == "PF4")],pointCol = ETV6_2020@meta.data$celltypes, curvesCols = curvesCols,
  border = FALSE)  + 
  ggplot2::scale_color_manual(values = curvesCols)  + 
  ggtitle("PF4",) +
  theme(plot.title = element_text(hjust = 0.5))
...
svg("ITGA2B.svg", width = 7, height = 7)
plotSmoothers(sce_fitGAM, counts_matrix,  rownames(counts_matrix)[which(rownames(counts_matrix) == "ITGA2B")],pointCol = ETV6_2020@meta.data$celltypes, curvesCols = curvesCols,
  border = FALSE)  + 
  ggplot2::scale_color_manual(values = curvesCols2)  + 
  ggtitle("ITGA2B",) +
  theme(plot.title = element_text(hjust = 0.5))
...
svg("ETV6.svg", width = 7, height = 7)
plotSmoothers(sce_fitGAM, counts_matrix,  rownames(counts_matrix)[which(rownames(counts_matrix) == "ETV6")],pointCol = ETV6_2020@meta.data$celltypes, curvesCols = curvesCols,
  border = FALSE)  + 
  ggplot2::scale_color_manual(values = curvesCols2)  + 
  ggtitle("ETV6",) +
  theme(plot.title = element_text(hjust = 0.5))
...
svg("DNM1L.svg", width = 7, height = 7)
plotSmoothers(sce_fitGAM, counts_matrix,  rownames(counts_matrix)[which(rownames(counts_matrix) == "DNM1L")],pointCol = ETV6_2020@meta.data$celltypes, curvesCols = curvesCols,
  border = FALSE)  + 
  ggplot2::scale_color_manual(values = curvesCols2)  + 
  ggtitle("DNM1L",) +
  theme(plot.title = element_text(hjust = 0.5))
...
svg("NDUFB9.svg", width = 7, height = 7)
plotSmoothers(sce_fitGAM, counts_matrix,  rownames(counts_matrix)[which(rownames(counts_matrix) == "NDUFB9")],pointCol = ETV6_2020@meta.data$celltypes, curvesCols = curvesCols,
  border = FALSE)  + 
  ggplot2::scale_color_manual(values = curvesCols2)  + 
  ggtitle("NDUFB9",) +
  theme(plot.title = element_text(hjust = 0.5))
...
svg("ZFPM1.svg", width = 7, height = 7)
plotSmoothers(sce_fitGAM, counts_matrix,  rownames(counts_matrix)[which(rownames(counts_matrix) == "ZFPM1")],pointCol = ETV6_2020@meta.data$celltypes, curvesCols = curvesCols,
  border = FALSE)  + 
  ggplot2::scale_color_manual(values = curvesCols2)  + 
  ggtitle("ZFPM1",) +
  theme(plot.title = element_text(hjust = 0.5))
...
## Plot RUNX1 gene expression in UMAP
```{r}
plotGeneCount(sds, counts, gene = "RUNX1")
```

## Plot Celltypes with Lineage 1
```{r}
ETV6_2020@meta.data$celltypes <- factor(ETV6_2020@meta.data$celltypes, levels = c("HSPC","GMP" ,"CMP","CMP_Primed","MEP","MkP_Mk","Plt"))

metadata <- as.data.frame(ETV6_2020@meta.data)
metadata$UMAP_1 <- ETV6_2020@reductions$umap@cell.embeddings[,1]
metadata$UMAP_2 <- ETV6_2020@reductions$umap@cell.embeddings[,2]
metadata$Lineage1_x <- sds@curves$Lineage1$s[,1]
metadata$Lineage1_y <- sds@curves$Lineage1$s[,2]
metadata$Lineage1_pseudotime <- pseudotime[,1]
metadata$Lineage2_x <- sds@curves$Lineage2$s[,1]
metadata$Lineage2_y <- sds@curves$Lineage2$s[,2]
metadata$Lineage2_pseudotime <- pseudotime[,2]
# identical(rownames(metadata), rownames(pseudotime))

visual1 = data.frame(UMAP_1=metadata$UMAP_1,UMAP_2=metadata$UMAP_2, celltypes = metadata$celltypes, pseudotime = metadata$Lineage1_pseudotime)
visual2 <-data.frame(UMAP_1=metadata$Lineage1_x,UMAP_2=metadata$Lineage1_y, celltypes = metadata$celltypes, pseudotime = metadata$Lineage1_pseudotime)
visual3 <-data.frame(UMAP_1=metadata$Lineage2_x,UMAP_2=metadata$Lineage2_y, celltypes = metadata$celltypes, pseudotime = metadata$Lineage2_pseudotime)

ggplot(visual1, 
       aes(UMAP_1,UMAP_2))+
  geom_point(aes(colour=factor(celltypes)), size=0.5)+
  geom_point(data= visual2, 
             aes(x=UMAP_1, y=UMAP_2),
             size=0.5,
             color="black")+
  geom_point(data= visual3, 
             aes(x=UMAP_1, y=UMAP_2),
             size=0.5,
             color="red")+
  ggtitle("Trajectory with Cell Type")+
