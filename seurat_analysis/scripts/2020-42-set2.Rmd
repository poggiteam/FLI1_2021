...
## Load path for files
PATH_HUMAN_DATA1 <- "$WORKING_DIR/seurat_analysis/data/mRNA/2020-42-set2/"
PATH_HTO_DATA1 <- "$WORKING_DIR/seurat_analysis/data/HTO/2020-42-set2/"
PATH_SOUPORCELL_DATA1 <- "$WORKING_DIR/souporcell/outputs/2020-42-set2/"
```
